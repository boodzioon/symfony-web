...
class CategoryTest extends KernelTestCase
{
    ...
    {
        yield [
            '<ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i>Games <a href="/admin/su/edit-category/23">Edytuj</a> <a onclick="return confirm(\'Are you sure?\');" href="/admin/su/delete-category/23">Usuń</a><ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i>Board Games <a href="/admin/su/edit-category/24">Edytuj</a> <a onclick="return confirm(\'Are you sure?\');" href="/admin/su/delete-category/24">Usuń</a></li><li><i class="fa-li fa fa-arrow-right"></i>Computer Games <a href="/admin/su/edit-category/25">Edytuj</a> <a onclick="return confirm(\'Are you sure?\');" href="/admin/su/delete-category/25">Usuń</a><ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i>RPG <a href="/admin/su/edit-category/29">Edytuj</a> <a onclick="return confirm(\'Are you sure?\');" href="/admin/su/delete-category/29">Usuń</a></li><li><i class="fa-li fa fa-arrow-right"></i>Sport Games <a href="/admin/su/edit-category/32">Edytuj</a> <a onclick="return confirm(\'Are you sure?\');" href="/admin/su/delete-category/32">Usuń</a></li><li><i class="fa-li fa fa-arrow-right"></i>Strategy <a href="/admin/su/edit-category/28">Edytuj</a> <a onclick="return confirm(\'Are you sure?\');" href="/admin/su/delete-category/28">Usuń</a><ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i>RTS <a href="/admin/su/edit-category/30">Edytuj</a> <a onclick="return confirm(\'Are you sure?\');" href="/admin/su/delete-category/30">Usuń</a></li><li><i class="fa-li fa fa-arrow-right"></i>Turn-Based <a href="/admin/su/edit-category/31">Edytuj</a> <a onclick="return confirm(\'Are you sure?\');" href="/admin/su/delete-category/31">Usuń</a></li></ul></li></ul></li></ul></li></ul>',
            [
        ...
        yield [
            '<ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i>Toys <a href="/admin/su/edit-category/2">Edytuj</a> <a onclick="return confirm(\'Are you sure?\');" href="/admin/su/delete-category/2">Usuń</a></li></ul>',
            [
