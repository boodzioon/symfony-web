...
class VideoFixtures extends Fixture
{
    ...
    {
        foreach ($this->VideoData() as [$title, $vimeo_id, $category_id]) {
    ...
    private function VideoData()
    {
        return [
            ...
            ['Family 1', 289729765, 18],
            ['Family 2', 289729765, 18],
            ['Family 3', 289729765, 18],
            ['Romantic comedy 1', 289729765, 20],
            ['Romantic comedy 2', 289729765, 20],
            ['Romantic drama 1', 289729765, 21],
            ['Toys  1', 289729765, 2],
            ['Toys  2', 289729765, 2],
            ['Toys  3', 289729765, 2],
            ['Toys  4', 289729765, 2],
