 ...
 */
final class Version20260320054404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "subscriptions" (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, plan VARCHAR(255) NOT NULL, valid_to TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, payment_status VARCHAR(45) DEFAULT NULL, free_plan_used BOOLEAN DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE "users" (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(45) NOT NULL, last_name VARCHAR(45) NOT NULL, vimeo_api_key VARCHAR(255) DEFAULT NULL, subscription_id INT DEFAULT NULL, PRIMARY KEY (id))');
